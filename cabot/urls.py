...
from cabot.cabotapp.views import (
    ...
    duplicate_json_check, duplicate_instance, acknowledge_alert, remove_acknowledgement,
    GraphiteCheckCreateView, GraphiteCheckUpdateView,
    HttpCheckCreateView, HttpCheckUpdateView,
    JsonCheckCreateView, JsonCheckUpdateView,
...
urlpatterns = [
     ...
     url(r'^jsoncheck/create/', view=JsonCheckCreateView.as_view(),
        name='create-json-check'),
     url(r'^jsoncheck/update/(?P<pk>\d+)/',
        view=JsonCheckUpdateView.as_view(), name='update-json-check'),
     url(r'^jsoncheck/duplicate/(?P<pk>\d+)/',
        view=duplicate_json_check, name='duplicate-json-check'),
